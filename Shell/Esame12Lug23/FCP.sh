#!/bin/bash
#File comandi principale inerente alla prova d'esame del 12 Luglio 2023
...
#Salvo il primo parametro che dovrà essere un valore numerico
X=$1
shift
...
#Creo file temporaneo che conterrà le occorrenze
tmp="/tmp/Occorrenze"
> $tmp

#Creo la variabile che conterrà la lunghezza massima dei file
max=0
