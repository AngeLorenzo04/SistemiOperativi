...
typedef struct {
    ...
    int c1; /* PID NIPOTE */
    char c2[250]; /* ULTIMA RIGA RICEVUTA DAL NIPOTE */
    int c3; /* LUNGHEEZZA DI C2 */
        ...
        if (pid == 0) {
         /* codice eseguito dal processo figlio*/
            ...
            if((write(pipePadreFiglio[n][1],&S,sizeof(struct_t))) < 0){ /* Scrivo */
               printf("ERRORE: qualcosa è andato storto nella scrittura 129\n");
               exit(-1);
            }
